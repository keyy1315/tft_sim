...
> 출처: `docs/wiki/raw/lolchess/set17-stargazer-constellations.md`
...
- [ ] `docs/wiki/raw/lolchess/set17-stargazer-constellations.md` 데이터를 `src/data/stargazer_constellations.json`으로 변환
...
> 정확한 트리 구조 + 전체 노드 효과: `docs/wiki/raw/lolchess/set17-factory-new-arsenal.md` 참고
...
- 별돌보미 세부: `docs/wiki/raw/lolchess/set17-stargazer-constellations.md`
- 최신상 세부: `docs/wiki/raw/lolchess/set17-factory-new-arsenal.md`
