...
export const CHAMPION_ABILITY_PATTERNS: Record<string, AbilityConfig> = {
  ...
  TFT17_Pantheon:    { pattern: 'cone', radius: 2, selfBuff: { durability: 0.15, duration: 4 }, dot: { duration: 4, perSecond: true } },  // 보호막+내구력 + 원뿔 매초 TrueDamagePerSecond(scaleAD) × 4 (Bard/Viktor/AurelionSol 동형 perSecond)
