...
export const CARRY_AUGMENTS: CarryAugmentConfig[] = [
  ...
  },
  {
    ...
    abilityData: {
      ...
      mana: '20/80',
      damage: [160, 240, 420], // 17.4: 170/250/450 → 160/240/420 (PR #164 — Codex P1 PR #162 catch). 실 sim damage 적용 — JaxCarry 전용 cast damage 분기 (combatLoop.ts:6879-6899 main + :7212-7240 OOR, PR #140 + #147). 17.3: 155/230/375 → 170/250/450
